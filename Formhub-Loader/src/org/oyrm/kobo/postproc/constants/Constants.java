...
public final class Constants {
	...
	public static final String PROPKEY_DIRNAME_XML_SYNC="PROPKEY_DIRNAME_XML_SYNC";
	public static final String PROPKEY_LOGGING_LEVEL = "PROPKEY_LOGGING_LEVEL";
	public static final String PROPKEY_DEVICE_ID="PROPKEY_DEVICE_ID";
	...
	public final static int DEVICE_ID_TEXT = 30;
	public final static int SYNC_XML_TASK_TEXT = 31;
	public final static int XML_SYNC_COMMAND = 32;
	public final static int SYNC_TO_ODK_SERVER = 33;
	public final static int ODK_AGGREGATE_COMMAND = 34; //new String("Aggregate");
	public final static int UNMOUNT_COMMAND = 35;
	public static final int Formhub_ID = 36;
}

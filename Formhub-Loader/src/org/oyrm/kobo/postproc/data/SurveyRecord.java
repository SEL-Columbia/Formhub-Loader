...
public class SurveyRecord {
	...
	public String getKey() {
		if(content.containsKey(Constants.KEY_KEY)) {
			...
			return content.get(Constants.KEY_DEVICEID) 
								+ "_"+content.get(Constants.KEY_START);
		} else {
			return "";
		}
	}
	...
	public String setAnswer(String questionID, String answer) {
		if (questionID.equals(Constants.KEY_DEVICEID)
			...
			String value = content.get(Constants.KEY_DEVICEID) 
							+ "_"+answer;
			content.put(Constants.KEY_KEY, value);
		}
	...
	public String toString(){
		return "\n"+getClass().getName() + 
			"\n@{Instance="+getInstance()+"  Key ="+ getKey()+"\n"+
			content.toString()+"}\n";
	}
}